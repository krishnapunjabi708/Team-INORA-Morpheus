...
//   final Set<Polygon> _polygons = {};
//   final Set<Marker> _markers = {};
//   final List<latlong.LatLng> _polygonPoints = [];
//   final TextEditingController _fieldNameController = TextEditingController();
//   final TextEditingController _searchController = TextEditingController();
//   final SupabaseClient _supabase = Supabase.instance.client;
//   bool _isSaving = false;
...
//     if (fieldName.isEmpty || _polygonPoints.length < 3) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text("Fill name and draw valid polygon")),
//       );
//       return;
//     }
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text("Field '$fieldName' saved successfully!")),
//       );
...
//                               userAgentPackageName: 'com.example.app',
//                                // Ensures labels are fully visible
//                             ),
...
//                       child: ElevatedButton(
//                         onPressed:
//                             _isConfirmEnabled ? _showFieldNameDialog : null,
//                         style: ElevatedButton.styleFrom(
//                           backgroundColor: Colors.white,
//                           foregroundColor: const Color(0xFF116A2A),
//                           padding: const EdgeInsets.symmetric(vertical: 16),
